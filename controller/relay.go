...
func relayHandler(c *gin.Context, info *relaycommon.RelayInfo) *types.NewAPIError {
	...
	case relayconstant.RelayModeCodexWebSearch:
		err = relay.CodexWebSearchHelper(c, info)
	default:
...
func Relay(c *gin.Context, relayFormat types.RelayFormat) {
	...
	newAPIError = relay.PrepareRelayAccounting(c, relayInfo, request, useUpstreamResponsesUsage)
	if newAPIError != nil {
		return
	}
...
func shouldRetry(c *gin.Context, openaiErr *types.NewAPIError, retryTimes int) bool {
	...
	if common.GetContextKeyBool(c, constant.ContextKeyRelayRetryCommitted) {
		return false
	}
