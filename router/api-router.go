...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		logRoute.GET("/model-request-counts", middleware.AdminAuth(), controller.GetLogModelRequestCounts)
		...
		dataRoute.GET("/earliest", middleware.AdminAuth(), controller.GetEarliestQuotaDataTime)
