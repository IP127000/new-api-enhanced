...
func TestGetRandomSatisfiedChannelUsesBaseAbilityForCompactEndpoint(t *testing.T) {
	const (
		groupName = "compact-fallback-test"
	...
	channel, err := GetRandomSatisfiedChannel(
		groupName,
		ratio_setting.WithCompactModelSuffix(modelName),
		0,
